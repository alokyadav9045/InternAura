...
<a onClick={handleSingin} class="flex items-center h-9 justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                   ...
                   <h1 class="cursor-pointer px-4 py-5 w-5/6 text-center text-xl text-gray-600 font-bold">Sign in with Google</h1>
...
<span className='border-b- w-1/5 lg:w-1/4'></span>
 ...
 <div class="mt-4">
             ...
             <div className="mt-4 flex items-center justify-between">
<p className='text-sm'>new to interAura? Register(<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>Student</span>/<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>company</span>) </p>
             </div>
</div>
                    </div>
                </div>
