...
<div className="first-int mb-14">
  <div className="filter-section w-40">
...
<div className="search-2">
  ...
  <label htmlFor="ex ">Experince</label><br></br>
...
<div className='shadow-lg rounded-lg bg-slate-300 m-7 ' id='display'>
  <div className="m-4">
...
<button>
<p className= ' mt-5 text-blue-400'>View more filters <i class="bi bi-chevron-down"></i></p></button>
<button><span className='justify-end flex text-blue-400 mr-3'>Clear all</span></button>
</div>
