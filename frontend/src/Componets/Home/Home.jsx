...
<p className='text-center text-lg font-bold'>Trending on InternAura 🔥</p>
...
<div className="infoys">
    <div className="info-intern">
        <div className="mt-16">
            <h1 className='text-center font-bold'>Latest internships on InternAura</h1>
        </div>
...
filterInternShips.map(( data,index)=>(
        ...
        <div className="int-1 mt-5 bg-slate-300" key={index}>
<p className='mb-4 mt-3' id='boxer'> <i className='bi bi-arrow-up-right text-blue-500' ></i> Actively Hiring</p>
<p>{data.title}</p>
<small className='text-black text-sm'>{data.company}</small>
...
<div className="logins flex h-30 mt-8">
<div className="cont">
<img className='bnn' src={logo} alt="logo" />
<p className="flex justify-center text-white text-xl items-center m-5 w-25">Empower your career with InternAura today</p>
</div>
<div className="log flex h-26">
