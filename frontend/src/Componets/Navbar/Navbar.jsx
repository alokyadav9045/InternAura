                    ...
                    <div className='elem'>
                        ...
                        <Link to={'/Jobs'}>
                            <p onMouseEnter={showJobs}>
                                Jobs <i id='ico2' className='bi bi-caret-down-fill' onClick={hideJobs}></i>
                            </p>
                        </Link>
                    </div>
                    ...
                    {user ? (
                        <>
                            <div className='Profile'>
                                <Link to={'/profile'}>
                                    <img src={user?.photo} alt='' onMouseEnter={showProfile} className='rounded-full w-12' id='picpro' />
